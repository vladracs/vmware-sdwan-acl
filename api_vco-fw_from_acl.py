...
# 
# Note: VMware SDWAN supports only single port or range of ports in each rule
# single ACE might expand into multiple SDWAN FW rules
# 
# Does not support operator = "neq"
# 
...
if (len(tmp) > 0):
    ...
    print()
    print("Edge already has FW module Override")
...
def destinations(new_rule):
 ...
 #  REPEATING FOR EACH DST PORT
                    ...
                    for ports in dstport:
                        ...
                        print("dstport eq=",dstport[j])
                        dport_high=dstport[j]
                        dport_low=dstport[j]
                        ####
     ...
     sport_low=-1
        ...
        sport_low=r1
            ...
            for ports in srcport:
                ...
                sport_high=srcport[k]
                sport_low=srcport[k]
                destinations(new_rule)
            k=k+1
            skip=True
    if(skip==False):
